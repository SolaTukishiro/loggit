...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 sm:p-6">
      ...
      {/* 打刻ウィジェット */}
      {activeLog && (
        <div className="flex flex-col gap-4 rounded-lg border border-gray-200 border-l-4 border-l-green-500 bg-white px-4 py-4 shadow-sm lg:flex-row lg:items-center lg:justify-between lg:px-5">
          ...
          <div className="text-left lg:text-center">
            <div className="font-mono text-2xl font-semibold text-gray-800 tracking-wide sm:text-3xl">
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
          ...
          <div className="px-4 py-2">
            ...
            {dueTasks.map((task) => (
              <div key={task.id} className="flex flex-wrap items-center gap-2.5 border-b border-gray-100 py-2 last:border-none">
